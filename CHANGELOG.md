...
## [0.8.2-v1.1] - 2026-09-08

### Added / Changed

- **Added 'Mute ambiance sounds' toggle in system tray context menu.** Users can now directly toggle Mood ambiance background sounds on or off from the taskbar notification area context menu with real-time state synchronization.
...
- **CI / Release Workflow Enhancements.** Added support for manual workflow dispatch from `main` branch to automatically create release builds directly from Cargo.toml version.

## [0.8.2-v1.0] - 2026-09-04
